            ...
            <div class="table-responsive">
                <table class="table mobile-table table-row-dashed table-row-gray-200 align-middle gy-2 table-custom mb-1">
                    ...
                    @foreach ($requests as $request)
                        @include('front.user.lecturer.courses.my_courses.live_lessons.partials.request-response')
                    @endforeach
                    </tbody>
                </table>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="cancelForm" data-url="{{route('user.lecturer.course.curriculum.live_lesson.requests.respond')}}">
