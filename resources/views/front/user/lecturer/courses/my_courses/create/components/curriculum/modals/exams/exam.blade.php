            ...
            <div class="py-3">
                ...
                <div class="scroll scroll-lesson">
                    <div class="modal-body px-5 py-0">
                        ...
                        <h2 class="text-center mb-4">{{ @$item ? __('edit_exam') . ": " .  @$item->title : __('add_new_exam') }}</h2>
                                    ...
                                    <div class="py-3 px-2 px-lg-4">
                                        @php
                                            if (checkUser('lecturer') && $user_type == "lecturer") {
                                                $action_set_url = route('user.lecturer.course.curriculum.quiz.set_quiz');
                                                $action_update_url = route('user.lecturer.course.curriculum.quiz.update_quiz');
                                                ...
                                                $action_update_url = route('panel.courses.edit.curriculum.quiz.update_quiz');
                                        ...
                                        <form id="course_exam_form"
                                            ...
                                            <input type="hidden" name="course_sections_id" id="course_sections_id" value="{{ @$course_section_id }}">
                                        <div class="row">
                                            @foreach (locales() as $locale => $value)
                                                <div class="form-group col-md-6 mt-3">
                                                    ...
                                                    <input class="form-control" id="title" type="text"
                                                        name="title_{{ $locale }}" value="{{ (@$item) ? @$item->translate($locale)->title : "" }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4 mt-3">
                                                <label>{{ __('grad') }}
                                                    <span class="text-danger">*</span></label>
                                                <input class="form-control" type="number" step="0.1" name="grade"
                                                    placeholder="{{ __('grad') }}"
                                                    value="{{ @$item->grade }}"  style="direction: rtl !important;"/>
                                            </div>

                                            <div class="form-group col-md-4 mt-3">
                                                <label>{{ __('pass_mark') }}
                                                    <span class="text-danger">*</span></label>
                                                <input class="form-control" type="number" step="0.1" name="pass_mark"
                                                    placeholder="{{ __('pass_mark') }}"
                                                    value="{{ @$item->pass_mark }}" style="direction: rtl !important;" />
                                            </div>
                                        </div>
...
<div class="question-template" style="display: none;">
    @include('front.user.lecturer.courses.my_courses.create.components.curriculum.modals.exams.question', ['question_no' => '__question_no__', 'item' => '', 'question' => ''])
</div>
