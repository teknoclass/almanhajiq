       ...
       <div class="row" >
           <div class="col-md-6">
               <div class="form-group">
                   ...
                   <select class="form-control" name="weekly_sessions" id="weekly_sessions" onchange="generateSessionInputs({{$item->published}});generateSessionCount()">
                       <option value="" disabled selected>{{ __('Select weekly session') }}</option>
                       @for ($i = 1; $i <= 7; $i++)
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                                ...
                                $now = now();
                                $isSessionNow = $sessionDateTime->equalTo($now) || $sessionDateTime->diffInMinutes($now) <= 120;
