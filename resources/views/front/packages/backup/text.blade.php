@extends('front.layouts.index', ['is_active'=>'courses','sub_title'=>'دورة نصية', ])
      ...
      <div class="row">
        <div class="col-12">
            ...
            <div class="card-body p-4">
              <div class="course-widget">
                ...
                <ul class="course-widget-list">
                  <li><a href=""> مخططات سير العمليات ذات التفرعات</a></li>
                  <li><a href="">سير العمليات ذات التكرار والدوران </a></li>
                </ul>
              </div>
              <div class="course-widget">
                <div class="course-widget-head d-flex align-items-center">
                  <div class="square me-2"></div>
                  <h4 class="font-medium">الشابتر الثاني : تمثيل الخوارزميات الأساسية</h4>
                </div>
                <ul class="course-widget-list">
                  <li><a href="">مخططات سير العمليات التتابعية</a></li>
                  <li><a href="">سير العمليات ذات التكرار والدوران </a></li>
                </ul>
              </div>
              <div class="course-widget">
                <div class="course-widget-head d-flex align-items-center">
                  <div class="square me-2"></div>
                  <h4 class="font-medium">الشابتر الثالث : تنفيذ الخوارزميات</h4>
                </div>
                <ul class="course-widget-list">
                  <li><a href="">سير العمليات ذات التكرار والدوران </a></li>
                </ul>
          ...
          <button class="btn bg-transparent border-0 px-0 d-inline-flex align-items-center">مشاهدة المزيد
            <div class="icon-chevron-down me-2"><i class="fa-solid fa-chevron-down"></i></div>
          </button>
        </div>
      </div>
    </div>
