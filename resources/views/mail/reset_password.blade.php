                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                            ...
                                                                            <h1 style="text-align: center;color: #fff">{{getNameWebSite()}} - اعادة تعيين كلمة المرور</h1>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                            ...
                                                                            <h3 dir="rtl" style="text-align: right;">اعادة تعيين كلمة المرور الخاصة بك..<br>
                                                                                <br>
                                                                                يمكنك تجاهل هذه الرسالة اذا لم تطلب اعادة تعيين كلمة المرور<br>
                                                                                <br>
                                                                                                    ...
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                                                                                                                <a class="mcnButton " title="استعادة كلمة المرور" href="{{ $actionUrl }}" target="_self" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">استعادة كلمة المرور</a>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
                                                                                                </table>
                                                                                ...
                                                                                <br>
                                                                                إذا كان لديك أي استفسار يرجى مراسلتنا عبر {{getEmail()}}
                                                                            </h3>
