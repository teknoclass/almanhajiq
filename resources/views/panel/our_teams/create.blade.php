@extends('panel.layouts.index',['sub_title' =>__('our_teams') ,'is_active'=>'our_teams'])
@section('contion')
@php
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
   ...
   [
   'title'=>__('our_teams') ,
   'link'=>route('panel.ourTeams.all.index'),
   ],
   [
   'title'=>$title_page,
   'link'=>'#',
   ...
   @endphp
    ...
    @section('title',__('our_teams').'-'.$title_page)
   ...
   <!--begin::Entry-->
       <div class="d-flex flex-column-fluid">
           ...
           <!--begin::Container-->
           <div class="container">
           @include('panel.layouts.breadcrumb',['breadcrumb_links'=>$breadcrumb_links,'title_page'=>__('our_teams'),])
      <!--begin::Form-->
                  ...
                  <div class="card card-custom gutter-b example example-compact">
                     ...
                     <div class="card-body">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="name_{{$locale}}" class="form-control" value="{{isset($item)?@$item->translate($locale)->name:''}}" required />
                        </div>
                        ...
                        <div class="form-group">
                            <label>{{__('job')}}
                               ({{ __($value) }} )
                               <span class="text-danger">*</span></label>
                            <input type="text" name="job_{{$locale}}" class="form-control" value="{{isset($item)?@$item->translate($locale)->job:''}}" required />
                         </div>
                         ...
                         <div class="form-group">
                            <label>{{__('description')}}
                               ({{ __($value) }} )
                               <span class="text-danger">*</span></label>
                            <input type="text" name="description_{{$locale}}" class="form-control" value="{{isset($item)?@$item->translate($locale)->description:''}}" required />
                         </div>
               ...
               <div class="col-md-3">
                  ...
                  <div class="card card-custom gutter-b example example-compact">
                     ...
                     <div class="card-body d-flex align-items-center   ">
                         ...
                         <a href="{{route('panel.ourTeams.all.index')}}" class="btn btn-secondary mx-3">{{__('cancel')}}</a>
