...
@section('title',  __('students_opinions'))
@section('contion')
...
@php
         ...
         <div class="card card-custom">
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
               <div class="card-title">
                  <h3 class="card-label">
                     {{__('students_opinions')}} </h3>
               </div>
               <div class="card-toolbar">
                  <!--begin::Button-->
                  <a href="{{route('panel.studentsOpinions.create.index')}}" class="btn btn-primary font-weight-bolder">
   ...
   @push('panel_js')
   @include('panel.students_opinions.partials.scripts')
