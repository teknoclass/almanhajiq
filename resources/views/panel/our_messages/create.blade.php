@extends('panel.layouts.index',['sub_title' =>__('our_messages') ,'is_active'=>'our_messages'])
@section('contion')
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    @php
        ...
        [
         'title'=>__('our_messages') ,
         'link'=>route('panel.ourMessages.all.index'),
        ],
        [
        'title'=>$title_page,
        'link'=>'#',
   ...
   @endphp
    @section('title',__('our_messages').'-'.$title_page)
   ...
   <div class="d-flex flex-column-fluid">
      <!--begin::Container-->
       <div class="container">
           @include('panel.layouts.breadcrumb',['breadcrumb_links'=>$breadcrumb_links,'title_page'=>__('our_messages'),])
           <!--begin::Form-->
      <!--begin::Form-->
               ...
               <div class="col-md-3">
                  ...
                  <div class="card card-custom gutter-b example example-compact">
                     ...
                     <div class="card-body d-flex align-items-center   ">
                         ...
                         <a href="{{route('panel.ourMessages.all.index')}}" class="btn btn-secondary mx-3">{{__('cancel')}}</a>
