...
@php
         ...
         <div class="card card-custom">
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
               ...
               <div class="card-toolbar">
                  <!--begin::Button-->
                  <a href="{{route('panel.ourPartners.create.index')}}" class="btn btn-primary font-weight-bolder">
   ...
   @push('panel_js')
   @include('panel.our_partners.partials.scripts')
