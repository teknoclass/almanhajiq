...
@section('contion')
    @php
        ...
        if (Str::contains(Request::url(), 'admin')) {
            $user_type = 'admin';
        } elseif (Str::contains(Request::url(), 'lecturer')) {
            $user_type = 'lecturer';
        }
    @endphp
                                        ...
                                        <div class="col-12">
                                                    ...
                                                    <div class="bg-light-green p-3 p-lg-4 rounded-2">
                                                        <div class="row gx-lg-3">
                                                            ...
                                                            @if (@$course->type != 'live')
                                                                ...
                                                                <div
                                                                    class="col-lg-{{ @$col_lg_w }} col-md-4 col-sm-6">
                                            ...
                                            <div class="row">
                                                <div class="mt-4 col-12  list-add-section">
                                                    @include(
                                                        'front.user.lecturer.courses.my_courses.create.components.curriculum.sections',
                                                        ['user_type' => @$user_type]
                                                    )
                                                </div>
                                            </div>
                            ...
                            editor.on('init', function() {
                                ...
                                if (uploadDialog) {
                                    ...
                                    infoText.textContent =
                                        "مسموح برفع الصور فقط بصيغ: JPG, JPEG, PNG, GIF, WEBP.";
