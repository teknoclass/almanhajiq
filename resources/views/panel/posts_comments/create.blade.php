...
@section('contion')
    ...
    @endphp
        ...
        @php
            $title_page=__('post_comments_edit');
           ...
           'link'=>route('panel.home'),
            ...
            [
           'title'=>__('post'),
           'link'=>route('panel.postsComments.all.index'),
                    ],
           [
           'title'=>$title_page,
           'link'=>'#',
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card card-custom gutter-b example example-compact">
                                ...
                                <div class="card-body  d-flex align-items-center">
                                    ...
                                    <a href="{{route('panel.postsComments.all.index')}}" class="btn btn-secondary mx-3">{{__('cancel')}}</a>
                                </div>
                                <!--end::Form-->
                            </div>
