...
Route::group(
    ...
    |show_course_categories|show_joining_certificates|show_countries|show_joining_sections|joining_sections|show_banks'
        ], function () {
            Route::group(['prefix' => 'create', 'as' => 'create.'], function () {
    ...
    |show_course_categories|show_joining_certificates|show_countries|show_joining_sections|joining_sections|show_banks'
        ...
        //posts_comments
        Route::group([
            'prefix' => 'posts_comments',
            'as' => 'postsComments.',
            'middleware' => 'permission:show_posts_comments'
        ], function () {
            Route::group(['prefix' => 'create', 'as' => 'create.'], function () {
        ...
        Route::group([
            'prefix' => 'our-partners',
            'as' => 'ourPartners.',
            'middleware' => 'permission:show_our_partners'
        ], function () {
        ...
        Route::group([
            'prefix' => 'our-teams',
            'as' => 'ourTeams.',
            'middleware' => 'permission:show_our_teams'
        ], function () {
        ...
        Route::group([
            'prefix' => 'our-services',
            'as' => 'ourServices.',
            'middleware' => 'permission:show_our_services'
        ], function () {
        ...
        Route::group([
            'prefix' => 'our-messages',
            'as' => 'ourMessages.',
            'middleware' => 'permission:show_our_messages'
        ], function () {
        ...
        // StudentsOpinions
        Route::group([
            'prefix' => 'student_opinions',
            'as' => 'studentsOpinions.',
            'middleware' => 'permission:show_students_opinions'
        ], function () {
        ...
        // home page sections
        Route::group([
            'prefix' => 'home-page-sections',
            'as' => 'homePageSections.',
            'middleware' => 'permission:show_home_page_sections'
        ], function () {
        ...
        // Add Course Requests
        Route::group([
            'prefix' => 'add-course-requests',
            'as' => 'addCourseRequests.',
            'middleware' => 'permission:show_add_course_requests'
        ], function () {
            Route::group(['prefix' => 'edit', 'as' => 'edit.'], function () {
        ...
        //course_comments
        Route::group([
            'prefix' => 'course_comments',
            'as' => 'courseComments.',
            /* 'middleware' => 'permission:show_course_comments' */
        ], function () {
        ...
        Route::group([
            ...
            'as' => 'courseRatings.',
            'middleware' => 'permission:show_course_ratings'
        ], function () {
        ...
        Route::group([
            'prefix' => 'private_lesson_ratings',
            'as' => 'PrivateLessonRatings.',
            'middleware' => 'permission:show_private_lesson_ratings'
        ], function () {
        ...
        Route::group([
            ...
            'as' => 'courseStudents.',
            'middleware' => 'permission:show_course_students'
        ], function () {
        ...
        Route::group([
            ...
            'middleware' => 'permission:show_certificate_templates'
        ], function () {
            Route::group(['prefix' => 'create', 'as' => 'create.'], function () {
        ...
        Route::group([
            ...
            'middleware' => 'permission:show_withdrawal_requests'
        ], function () {
        ...
        Route::group([
            'prefix' => 'marketers-joining-requests',
            'as' => 'marketersJoiningRequests.',
            'middleware' => 'permission:show_marketers_joining_requests'
        ], function () {
        ...
        //marketersTemplates
        Route::group([
            'prefix' => 'marketers-templates',
            'as' => 'marketersTemplates.',
            'middleware' => 'permission:show_marketers_templates'
        ], function () {
            Route::group(['prefix' => 'create', 'as' => 'create.'], function () {
        ...
        //coupons
        Route::get('/download-coupons', [CouponsController::class, 'download'])->name('download-coupons');
